...
<body class="leading-normal tracking-normal text-black" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <!--Center Text-->
    <div class="container lg:pl-32 mx-auto flex flex-wrap pt-32 flex-col md:flex-row items-center mb-16">
        <div class="flex flex-col lg:pl-20 sm:px-2 w-full md:w-2/5 justify-center sm:text-center items-start md:text-left">
            <p class="uppercase tracking-loose md:text-lg w-full">What business are you?</p>
            <h1 class="my-4 text-4xl lg:text-5xl font-bold leading-tight">
                Main Hero Message to sell yourself!
            </h1>
            <p class="leading-normal lg:text-2xl mb-8">
                Sub-hero message, not too long and not too short. Make it just right!
            </p>
            <button
                class="hover:bg-#6C8EAF w-36 h-12 text-center bg-blue-200 text-gray-800 font-bold rounded-full px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-125 duration-300 ease-in-out">
                Search
            </button>
        </div>
        <div class="w-full md:w-3/5 py-3 text-center">
            <img src="image/Shop Background Final.png" class="w-full md:w-4/5 z-40">
        </div>
    </div>
    <!--Shops-->
    <section class="bg-gray-700 border-b py-8 ">
        <div class="container mx-auto flex flex-wrap pt-14 pb-12 md:content-around">
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col flex-shrink">
                <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                    <a href="#">
                        <img class="rounded-t-lg" src="img/cert5.png" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="#">
                        ...
                        <a href="#"
                            class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-200 rounded-lg hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-600">
                            Read more
                        </a>
                    </div>
                </div>
    ...
    <section class="bg-white border-b py-8">
        <div class="container max-w-5xl mx-auto m-8">
            ...
            <div class="w-full mb-4">
                <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 bg-gray-400 py-0 rounded-t"></div>
            </div>
